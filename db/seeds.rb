...
#     Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB_CORE_SOFT_MATTE_FOUNDATION_110_1200x1500_72DPI_6dbcc668-a5b5-455e-a9c4-9d65bb07ccf3_650x.jpg?v=1629309442", product_id: foundation.id)
#     #N2
...
#     Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30031_FB021_t_650x.jpg?v=1623427027", product_id: tint.id)
#     #2
...
#    brown = Color.create(color: "#340", url:"https://cdn.shopify.com/s/files/1/0341/3458/9485/products/44558_Foundation_Smear_1200x1500_RGB_495_650x.png?v=1629139895" )
...
#     Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB_CORE_SOFT_MATTE_FOUNDATION_495_1200x1500_72DPI_650x.jpg?v=1629838225", product_id: matte.id, color_id: brown.id )
...
# #3
# Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB40026_FB4089_650x.jpg?v=1614391059", product_id: gloss.id)
# Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB40026_FB4089_smear_650x.png?v=1615087247", product_id: gloss.id)
# Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB40026_FB4089_briggs_650x.jpg?v=1615087247", product_id: gloss.id)
...
#     Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FS20001_alt11_b7588be5-87b5-4b95-9f21-91ed261865cc_650x.jpg?v=1630437936", product_id: cleanser.id)
    ...
    light = Color.create(name: "#110", url:"https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0110_alt2_650x.png?v=1629310414")
    meduim = Color.create(name: "#120", url:"https://cdn.shopify.com/s/files/1/0341/3458/9485/products/44763_Foundation_Concrete_Closed_1200x1500_RGB_145_650x.jpg?v=1629310058" )
    dark = Color.create(name: "#130", url:"https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0160_alt2_650x.png?v=1629310475" )
    dark2 = Color.create(name: "#140", url:"https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0235_alt2_650x.png?v=1629312592" )

    # Images for foundation 
    f_image = Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0110_de9d1892-72ff-40fa-8f79-889f1cf19966_650x.jpg?v=1629310009", product_id: foundation.id, color_id: light.id )
    byebug
    Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0110_alt2_650x.png?v=1629310414", product_id: foundation.id, color_id: light.id )
    Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB_CORE_SOFT_MATTE_FOUNDATION_110_1200x1500_72DPI_6dbcc668-a5b5-455e-a9c4-9d65bb07ccf3_650x.jpg?v=1629309442", product_id: foundation.id, color_id: light.id )
    #N2
    Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0120_650x.jpg?v=1629310026", product_id: foundation.id)
    Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB30006_FB0120_alt2_650x.png?v=1629310423", product_id: foundation.id)
    Image.create( url: "https://cdn.shopify.com/s/files/1/0341/3458/9485/products/FB_CORE_SOFT_MATTE_FOUNDATION_140_1200x1500_72DPI_814c4594-a5ec-4fc9-8ea1-9b6e9c9a3cd4_650x.jpg?v=1629309699", product_id: foundation.id)
